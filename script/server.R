                      ...
                      wellPanel(
                        fluidRow( 
                          column( 12,
                                  ...
                                  boxInputLarge(inputId="dataParse_table", "Table data manipulation code:", value=Defaults$dataParse),
                                  ...
                                  boxInputLarge(inputId="dataParse_source", "Source data manipulation code:", value=Defaults$dataParse),
                                  ...
                                  boxInputLarge(inputId="dataParse", "Combined data manipulation code:", value=Defaults$dataParse)
                          )
                        )
                      )  
                    )
